...
import { ArrowUpRight, CalendarDays, ChevronLeft, ChevronRight, Plus, SmilePlus } from 'lucide-react'
...
export default function DentalClientStitchDashboard() {
  ...
  const appointmentDates = useMemo(() => new Set(calendarAppointments.map((item) => item.appointment_date.slice(0, 10))), [calendarAppointments])
  ...
  const upcoming = appointments[0] || calendarAppointments[0]
