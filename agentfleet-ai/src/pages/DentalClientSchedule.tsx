...
export default function DentalClientSchedule() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] px-4 py-5 pb-24 sm:px-6 lg:px-8"><div className="mb-5 flex flex-col justify-between gap-4 lg:flex-row lg:items-center"><div><p className="text-xs font-bold uppercase tracking-[0.18em] text-[#005db6]">Clinic operations</p><h1 className="mt-1 text-2xl font-bold text-[#151c23] sm:text-3xl">Appointment Schedule</h1><div className="mt-2 flex items-center gap-3 text-xs text-[#424752]"><span className="flex items-center gap-1 font-bold text-green-600"><span className="h-1.5 w-1.5 rounded-full bg-green-600" /> Clinic Open</span><span>08:00 AM - 06:00 PM</span></div></div><button onClick={() => setBookingOpen(true)} className="flex items-center justify-center gap-2 rounded-xl bg-[#005db6] px-4 py-3 text-xs font-bold text-white shadow-md"><Plus size={17} /> <span>Quick Add</span></button></div>
